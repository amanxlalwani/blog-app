...
export default function Blog() {
  ...
  function hasSubscribed(
    User: { id: string; user_id: string; subscriber_id: string }[]
  ): boolean {
    var val = false;
    User.forEach((ele) => {
      var c = 0;
    ...
    <>
      ...
      <div className={modal || isBlur ? "blur-sm  select-none" : ""}>
        <div
          ...
          className="w-11/12 m-auto px-6 mt-14 pb-8 lg:grid lg:gap-4 lg:grid-cols-4 break-words "
        >
          <div className="lg:col-span-3 ">
            <div className="text-2xl lg:text-5xl  font-extrabold">
              {blog.title}
            </div>
            <div className="text-sm my-2 mb-4 text-gray-500">
              Posted On {blog.publish_date.slice(0, 10)}
            </div>
