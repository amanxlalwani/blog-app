...
export default function MyBlogs() {
  ...
  useEffect(() => {
    axios
      .get("https://backend.aman-lalwani208.workers.dev/api/v1/blog/myblogs", {
        headers: {
    ...
    setInterval(() => {
      axios
        .get(
          "https://backend.aman-lalwani208.workers.dev/api/v1/blog/myblogs",
          {
            headers: {
              Authorization: localStorage.getItem("token"),
            },
      ...
      <>
        <div className={modal ? "blur-sm  select-none" : ""}>
          ...
          <div
            ...
            className="lg:w-1/2 max-w-full lg:m-auto lg:mt-24 px-4 pb-8"
          >
    ...
    <>
      ...
      >
        <div className="lg:w-1/2 max-w-full  lg:m-auto lg:mt-24 px-4">
          <div className="font-semibold text-3xl text-center lg:text-left lg:text-5xl w-full mt-10 lg:mt-2">
            My Blogs
          </div>
          {blogs.map(
            (blog: {
