...
export default function Signin(){
    ...
    <div className="grid grid-cols-1 lg:gap-4 lg:grid-cols-2 place-content-center content-stretch h-full">
     ...
     <div className="flex flex-col justify-center items-center">
        <div className="flex flex-col justify-center items-center">
            <h1 className=" text-center  text-4xl font-bold"> Sign In into your account </h1>
            <div className="text-gray-400  text-lg mb-6 mt-2 font-semibold"> Don't have an account? <span className="underline cursor-pointer" onClick={()=>{navigate("/signup")}}>Sign Up</span> </div>
        </div>
       <div className="w-3/6">
