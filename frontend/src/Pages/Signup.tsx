...
export default function Signup(){
    ...
    const [user,setUser]=useState<signupType>({name:"",email:"",password:""})
    ...
    <div className="grid grid-cols-1 lg:gap-4 lg:grid-cols-2 place-content-center content-stretch h-full">
     ...
     <div className="flex flex-col justify-center items-center">
        <div className="flex flex-col justify-center items-center">
            <h1 className="text-center text-3xl md:text-4xl font-bold"> Create an account </h1>
            <div className="text-gray-400 text-md md:text-lg mb-6 mt-2 font-semibold"> Already have an account? <span className="underline cursor-pointer" onClick={()=>{navigate("/signin")}}>Login</span> </div>
        </div>
       <div className="w-3/6"><InputBox  name="Name" placeholder="Enter your name" type='text' onChange={(e)=>setUser({...user,name:e.target.value})}  ></InputBox>
    ...
    <Button onClick={async () =>{ await apiCall(user)}} title="Sign Up" ></Button></div>
