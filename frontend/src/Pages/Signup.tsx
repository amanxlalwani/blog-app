    ...
    <div className="grid grid-cols-1 lg:gap-4 lg:grid-cols-2 place-content-center content-stretch h-full">
     ...
     <div className="flex flex-col justify-center items-center">
        <div className="flex flex-col justify-center items-center">
            ...
            <div className="text-gray-400  text-lg mb-6 mt-2 font-semibold"> Already have an account? <span className="underline cursor-pointer" onClick={()=>{navigate("/signin")}}>Login</span> </div>
        </div>
